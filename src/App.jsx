...
');
    ...
    function PublicCard({ data, shareUrl, theme, onBack }) {
      ...
      return (
        <div className="page dark-bg">
          ...
          <div className="public-grid">
            <section className={`hero-card ${theme.className}`}>
              ...
              <div className="contact-list">
                ...
                {data.website ? <a href={data.website} target="_blank" rel="noreferrer">{data.website}</a> : null}
              </div>
            </section>
    ...
    export default function App() {
      ...
      if (loadedFromLink) {
        return <PublicCard data={data} shareUrl={shareUrl} theme={theme} onBack={goBackToBuilder} />;
      }
          ...
          <div className="app-grid">
            <section className="panel form-panel">
              ...
              <label className="full-width">
                <span>Short Bio</span>
                <textarea value={data.bio} onChange={(e) => updateField('bio', e.target.value)} rows="5" />
              </label>
              ...
              <div className="theme-select">
                ...
                <div className="theme-grid">
                  {Object.entries(themes).map(([key, item]) => (
                    ...
                    >
                      <div className={`theme-swatch ${item.className}`}></div>
            ...
            <section className="side-column">
              <div className={`preview-card ${theme.className}`}>
